@AbapCatalog.sqlViewName: 'ZISDR1085_16'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Interlocutor pedido venta - tiendas'
define view ZISDR1085_INTERLO_TIENDA
...
where
  ...
  and(
       interlocutor.parvw              = 'MF'
    or interlocutor.parvw              = 'WD'
  )
