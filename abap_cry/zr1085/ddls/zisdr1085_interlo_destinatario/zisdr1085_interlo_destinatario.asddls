@AbapCatalog.sqlViewName: 'ZISDR1085_20'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Interlocutor pedido venta - Destinatario'
define view ZISDR1085_INTERLO_DESTINATARIO
