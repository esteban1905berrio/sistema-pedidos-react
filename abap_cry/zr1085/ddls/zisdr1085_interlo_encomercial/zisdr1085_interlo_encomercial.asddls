@AbapCatalog.sqlViewName: 'ZISDR1085_21'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Inter pedido venta - Encargado Comercial'
define view ZISDR1085_INTERLO_ENCOMERCIAL
