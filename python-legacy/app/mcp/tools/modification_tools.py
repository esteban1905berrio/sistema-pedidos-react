...
def register_modification_tools(mcp: FastMCP, service_getter: Callable[[], ModificationService]):
    ...
    def modify_function_module(
        ...
        """
        return service_getter().modify_function_module(
    ...
    def modify_class(
        ...
        """
        return service_getter().modify_class(
    ...
    def modify_program(
        ...
        Returns detailed status for each step.
        """
        return service_getter().modify_program(
    ...
    def modify_include(
        ...
        Returns detailed status for each step.
        """
        return service_getter().modify_include(
