...
def register_class_tools(mcp: FastMCP, service_getter: Callable[[], ClassService]):
    """
    Register class-related tools with the MCP server.

    Args:
        mcp: FastMCP server instance
        service_getter: Callable that returns ClassService instance (lazy-loaded)
    """
    ...
    def get_class_source(
        ...
        """
        return service_getter().get_class_source(class_name, version=version, include_type=include_type)
    ...
    def get_class_structure(
        ...
        """
        return service_getter().get_class_structure(class_name, version=version)
    ...
    def get_object_source(
        ...
        """
        return service_getter().get_object_source(object_uri, version=version)
    ...
    def get_class_includes(
        ...
        """
        return service_getter().get_class_includes(class_name)
    ...
    def get_class_components(
        ...
        """
        return service_getter().get_class_components(class_name, version)
    ...
    def get_object_structure(
        ...
        """
        return service_getter().get_object_structure(object_uri)
