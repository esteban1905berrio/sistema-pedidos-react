...
def register_rap_tools(mcp: FastMCP, service_getter: Callable[[], RAPService]):
    ...
    def get_service_binding(
        ...
        return service_getter().get_service_binding(binding_name, version)
    ...
    def get_service_definition_metadata(
        ...
        return service_getter().get_service_definition_metadata(srvd_name, version)
    ...
    def get_service_definition_source(
        ...
        return service_getter().get_service_definition_source(srvd_name, version)
    ...
    def get_odata_service_info(
        ...
        return service_getter().get_odata_service_info(service_name)
    ...
    def get_metadata_extension(
        ...
        return service_getter().get_metadata_extension(ddlx_name, version)
    ...
    def get_ddlx_parser_info() -> dict:
        ...
        return service_getter().get_ddlx_parser_info()
    ...
    def get_behavior_definition(
        ...
        return service_getter().get_behavior_definition(bdef_name, version)
    ...
    def explore_rap_object(
        ...
        """
        return service_getter().explore_rap_object(object_name, object_type)
