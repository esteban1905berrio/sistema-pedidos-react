...
def register_code_quality_tools(mcp: FastMCP, service_getter: Callable[[], CodeQualityService]):
    ...
    def syntax_check(
        ...
        return service_getter().syntax_check(object_uri, include_uri, source, version)
    ...
    def prettyprint(
        ...
        return service_getter().prettyprint(source)
    ...
    def get_prettyprint_settings() -> dict:
        ...
        return service_getter().get_prettyprint_settings()
    ...
    def set_prettyprint_settings(
        ...
        return service_getter().set_prettyprint_settings(indent, style)
