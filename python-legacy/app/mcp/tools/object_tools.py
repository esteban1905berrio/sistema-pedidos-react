...
def register_object_tools(mcp: FastMCP, service_getter: Callable[[], ObjectService]):
    ...
    def lock(
        ...
        return service_getter().lock(object_uri, access_mode)
    ...
    def unlock(
        ...
        return service_getter().unlock(object_uri, lock_handle)
    ...
    def set_object_source(
        ...
        return service_getter().set_object_source(
            object_uri,
            source_code,
            lock_handle,
            transport=transport
