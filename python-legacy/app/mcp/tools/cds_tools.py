...
def register_cds_tools(mcp: FastMCP, service_getter: Callable[[], CDSService]):
    ...
    def get_cds_view_metadata(
        ...
        """
        return service_getter().get_cds_view_metadata(cds_name, version)
    ...
    def get_cds_view_source(
        ...
        """
        return service_getter().get_cds_view_source(cds_name, version)
    ...
    def search_cds_views_by_sqlview(
        ...
        """
        return service_getter().search_cds_views_by_sqlview(sql_view_name, max_results)
    ...
    def get_cds_view_properties(
        ...
        """
        return service_getter().get_cds_view_properties(cds_name)
