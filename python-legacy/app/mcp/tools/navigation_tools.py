...
def register_navigation_tools(mcp: FastMCP, service_getter: Callable[[], NavigationService]):
    """
    Register navigation-related tools with the MCP server.

    Args:
        mcp: FastMCP server instance
        navigation_service: Callable that returns NavigationService instance (lazy-loaded) for repository navigation operations
    """
    ...
    def get_node_contents(
        ...
        """
        return service_getter().get_node_contents(node_uri, project_name)
    ...
    def find_object_path(
        ...
        """
        return service_getter().find_object_path(object_uri)
    ...
    def get_package_objects(
        ...
        """
        return service_getter().get_package_objects(
            package_name,
            max_rows,
            offset,
            object_types,
