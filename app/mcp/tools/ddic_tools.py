...
def register_ddic_tools(mcp: FastMCP, ddic_service: DdicService):
    """
    Register DDIC-related tools with the MCP server.

    Args:
        mcp: FastMCP server instance
        ddic_service: DdicService instance for DDIC operations
    """
    ...
    def get_ddic_element(
        ...
        """
        return ddic_service.get_ddic_element(element_name, element_type)
    ...
    def ddic_repository_access(
        ...
        """
        return ddic_service.ddic_repository_access(path)
    ...
    def get_annotation_definitions() -> List[Dict[str, Any]]:
        ...
        """
        return ddic_service.get_annotation_definitions()
    ...
    def package_search_help(
        ...
        """
        return ddic_service.package_search_help(query, max_results)
