...
def register_whereused_tools(mcp: FastMCP, whereused_service: WhereUsedService):
    ...
    def get_usage_references(
        ...
        """
        return whereused_service.get_usage_references(object_uri, object_type)
    ...
    def get_usage_snippets(
        ...
        """
        return whereused_service.get_usage_snippets(object_identifier, max_results)
