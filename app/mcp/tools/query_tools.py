...
def register_query_tools(mcp: FastMCP, query_service: QueryService):
    """
    Register query-related tools with the MCP server.

    Args:
        mcp: FastMCP server instance
        query_service: QueryService instance for data query operations
    """
    ...
    def get_table_contents(
        ...
        """
        return query_service.get_table_contents(
    ...
    def run_query(
        ...
        """
        return query_service.run_query(query_definition)
