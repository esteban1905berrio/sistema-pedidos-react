...
def register_enhancement_tools(mcp: FastMCP, enhancement_service: EnhancementService):
    ...
    def search_enhancements(
        ...
        """
        return enhancement_service.search_enhancements(package, enhancement_type)
    ...
    def get_enhancement_metadata(
        ...
        """
        return enhancement_service.get_enhancement_metadata(enhancement_name, enhancement_subtype)
    ...
    def get_enhancement_source(
        ...
        """
        return enhancement_service.get_enhancement_source(enhancement_name, enhancement_subtype)
