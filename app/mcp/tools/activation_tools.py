...
def register_activation_tools(mcp: FastMCP, activation_service: ActivationService):
    ...
    def activate(
        ...
        return activation_service.activate(object_name, object_uri, preaudit)
    ...
    def activate_objects(
        ...
        return activation_service.activate_objects(objects, preaudit)
    ...
    def get_inactive_objects() -> list:
        ...
        return activation_service.get_inactive_objects()
